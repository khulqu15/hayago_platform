<template>
    <div id="notification-container" class="fixed left-0 w-full transition-all gap-x-4"
    :class="{ '-bottom-24': !isVisible, '-bottom-0': isVisible }">
        <div role="alert" class="flex justify-between rounded-t-xl p-3 relative"
        :class="{'bg-success': type == 'success', 'bg-warning': type == 'warning', 'bg-error': type == 'error'}">
